...
# volume script for the raspberry pi
# needs amixer
# USAGE:
# vol.sh     # Outputs the current volume as a number between 0 and 100
# vol.sh +   # Turn up the volume by 3
# vol.sh -   # Turn down the volume by 3
# vol.sh 85  # Set the volume to 85
